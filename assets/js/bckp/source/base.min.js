...
+function(b){function e(d){return this.each(function(){var a=b(this),h=a.data("bs.carousel"),c=b.extend({},f.DEFAULTS,a.data(),"object"==typeof d&&d),e="string"==typeof d?d:c.slide;h||a.data("bs.carousel",h=new f(this,c));"number"==typeof d?h.to(d):e?h[e]():c.interval&&h.pause().cycle()})}var f=function(d,a){this.$element=b(d);this.$indicators=this.$element.find(".carousel-indicators");this.options=a;this.paused=this.sliding=this.interval=this.$active=this.$items=null;this.options.keyboard&&this.$element.on("keydown.bs.carousel",
b.proxy(this.keydown,this));"hover"!=this.options.pause||"ontouchstart"in document.documentElement||this.$element.on("mouseenter.bs.carousel",b.proxy(this.pause,this)).on("mouseleave.bs.carousel",b.proxy(this.cycle,this))};f.VERSION="3.3.1";f.TRANSITION_DURATION=600;f.DEFAULTS={interval:5E3,pause:"hover",wrap:!0,keyboard:!0};f.prototype.keydown=function(d){if(!/input|textarea/i.test(d.target.tagName)){switch(d.which){case 37:this.prev();break;case 39:this.next();break;default:return}d.preventDefault()}};
f.prototype.cycle=function(d){return d||(this.paused=!1),this.interval&&clearInterval(this.interval),this.options.interval&&!this.paused&&(this.interval=setInterval(b.proxy(this.next,this),this.options.interval)),this};f.prototype.getItemIndex=function(d){return this.$items=d.parent().children(".item"),this.$items.index(d||this.$active)};f.prototype.getItemForDirection=function(d,a){var b="prev"==d?-1:1,b=(this.getItemIndex(a)+b)%this.$items.length;return this.$items.eq(b)};f.prototype.to=function(d){var a=
this,b=this.getItemIndex(this.$active=this.$element.find(".item.active"));return d>this.$items.length-1||0>d?void 0:this.sliding?this.$element.one("slid.bs.carousel",function(){a.to(d)}):b==d?this.pause().cycle():this.slide(d>b?"next":"prev",this.$items.eq(d))};f.prototype.pause=function(d){return d||(this.paused=!0),this.$element.find(".next, .prev").length&&b.support.transition&&(this.$element.trigger(b.support.transition.end),this.cycle(!0)),this.interval=clearInterval(this.interval),this};f.prototype.next=
function(){return this.sliding?void 0:this.slide("next")};f.prototype.prev=function(){return this.sliding?void 0:this.slide("prev")};f.prototype.slide=function(d,a){var h=this.$element.find(".item.active"),c=a||this.getItemForDirection(d,h),e=this.interval,k="next"==d?"left":"right",n="next"==d?"first":"last",q=this;if(!c.length){if(!this.options.wrap)return;c=this.$element.find(".item")[n]()}if(c.hasClass("active"))return this.sliding=!1;var n=c[0],p=b.Event("slide.bs.carousel",{relatedTarget:n,
direction:k});if(this.$element.trigger(p),!p.isDefaultPrevented()){if(this.sliding=!0,e&&this.pause(),this.$indicators.length)this.$indicators.find(".active").removeClass("active"),(p=b(this.$indicators.children()[this.getItemIndex(c)]))&&p.addClass("active");var r=b.Event("slid.bs.carousel",{relatedTarget:n,direction:k});return b.support.transition&&this.$element.hasClass("slide")?(c.addClass(d),c[0].offsetWidth,h.addClass(k),c.addClass(k),h.one("bsTransitionEnd",function(){c.removeClass([d,k].join(" ")).addClass("active");
h.removeClass(["active",k].join(" "));q.sliding=!1;setTimeout(function(){q.$element.trigger(r)},0)}).emulateTransitionEnd(f.TRANSITION_DURATION)):(h.removeClass("active"),c.addClass("active"),this.sliding=!1,this.$element.trigger(r)),e&&this.cycle(),this}};var c=b.fn.carousel;b.fn.carousel=e;b.fn.carousel.Constructor=f;b.fn.carousel.noConflict=function(){return b.fn.carousel=c,this};var a=function(d){var a,c=b(this),l=b(c.attr("data-target")||(a=c.attr("href"))&&a.replace(/.*(?=#[^\s]+$)/,""));l.hasClass("carousel")&&
(a=b.extend({},l.data(),c.data()),(c=c.attr("data-slide-to"))&&(a.interval=!1),e.call(l,a),c&&l.data("bs.carousel").to(c),d.preventDefault())};b(document).on("click.bs.carousel.data-api","[data-slide]",a).on("click.bs.carousel.data-api","[data-slide-to]",a);b(window).on("load",function(){b('[data-ride="carousel"]').each(function(){var d=b(this);e.call(d,d.data())})})}(jQuery);
+function(b){function e(d){var a;d=d.attr("data-target")||(a=d.attr("href"))&&a.replace(/.*(?=#[^\s]+$)/,"");return b(d)}function f(d){return this.each(function(){var a=b(this),h=a.data("bs.collapse"),l=b.extend({},c.DEFAULTS,a.data(),"object"==typeof d&&d);!h&&l.toggle&&"show"==d&&(l.toggle=!1);h||a.data("bs.collapse",h=new c(this,l));"string"==typeof d&&h[d]()})}var c=function(a,g){this.$element=b(a);this.options=b.extend({},c.DEFAULTS,g);this.$trigger=b(this.options.trigger).filter('[href="#'+
...
"hide":"show"]()};c.prototype.getParent=function(){return b(this.options.parent).find('[data-toggle="collapse"][data-parent="'+this.options.parent+'"]').each(b.proxy(function(a,c){var h=b(c);this.addAriaAndCollapsedClass(e(h),h)},this)).end()};c.prototype.addAriaAndCollapsedClass=function(a,b){var c=a.hasClass("in");a.attr("aria-expanded",c);b.toggleClass("collapsed",!c).attr("aria-expanded",c)};var a=b.fn.collapse;b.fn.collapse=f;b.fn.collapse.Constructor=c;b.fn.collapse.noConflict=function(){return b.fn.collapse=
a,this};b(document).on("click.bs.collapse.data-api",'[data-toggle="collapse"]',function(a){var c=b(this);c.attr("data-target")||a.preventDefault();a=e(c);c=a.data("bs.collapse")?"toggle":b.extend({},c.data(),{trigger:this});f.call(a,c)})}(jQuery);
...
this.options.backdrop){var h=b.support.transition&&c;if(this.$backdrop=b('<div class="modal-backdrop '+c+'" />').prependTo(this.$element).on("click.dismiss.bs.modal",b.proxy(function(a){a.target===a.currentTarget&&("static"==this.options.backdrop?this.$element[0].focus.call(this.$element[0]):this.hide.call(this))},this)),h&&this.$backdrop[0].offsetWidth,this.$backdrop.addClass("in"),a)h?this.$backdrop.one("bsTransitionEnd",a).emulateTransitionEnd(f.BACKDROP_TRANSITION_DURATION):a()}else!this.isShown&&
...
function(){var a=parseInt(this.$body.css("padding-right")||0,10);this.bodyIsOverflowing&&this.$body.css("padding-right",a+this.scrollbarWidth)};f.prototype.resetScrollbar=function(){this.$body.css("padding-right","")};f.prototype.measureScrollbar=function(){var a=document.createElement("div");a.className="modal-scrollbar-measure";this.$body.append(a);var d=a.offsetWidth-a.clientWidth;return this.$body[0].removeChild(a),d};var c=b.fn.modal;b.fn.modal=e;b.fn.modal.Constructor=f;b.fn.modal.noConflict=
function(){return b.fn.modal=c,this};b(document).on("click.bs.modal.data-api",'[data-toggle="modal"]',function(a){var d=b(this),c=d.attr("href"),h=b(d.attr("data-target")||c&&c.replace(/.*(?=#[^\s]+$)/,"")),c=h.data("bs.modal")?"toggle":b.extend({remote:!/#/.test(c)&&c},h.data(),d.data());d.is("a")&&a.preventDefault();h.one("show.bs.modal",function(a){a.isDefaultPrevented()||h.one("hidden.bs.modal",function(){d.is(":visible")&&d.trigger("focus")})});e.call(h,c,this)})}(jQuery);
+function(b){var e=function(b,a){this.type=this.options=this.enabled=this.timeout=this.hoverState=this.$element=null;this.init("tooltip",b,a)};e.VERSION="3.3.1";e.TRANSITION_DURATION=150;e.DEFAULTS={animation:!0,placement:"top",selector:!1,template:'<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',trigger:"hover focus",title:"",delay:0,html:!1,container:!1,viewport:{selector:"body",padding:0}};e.prototype.init=function(c,a,d){this.enabled=
...
var a=b.contains(this.$element[0].ownerDocument.documentElement,this.$element[0]);if(!c.isDefaultPrevented()&&a){var d=this,c=this.tip(),a=this.getUID(this.type);this.setContent();c.attr("id",a);this.$element.attr("aria-describedby",a);this.options.animation&&c.addClass("fade");var a="function"==typeof this.options.placement?this.options.placement.call(this,c[0],this.$element[0]):this.options.placement,g=/\s?auto?\s?/i,h=g.test(a);h&&(a=a.replace(g,"")||"top");c.detach().css({top:0,left:0,display:"block"}).addClass(a).data("bs."+
this.type,this);this.options.container?c.appendTo(this.options.container):c.insertAfter(this.$element);var g=this.getPosition(),f=c[0].offsetWidth,m=c[0].offsetHeight;if(h){var h=a,k=this.options.container?b(this.options.container):this.$element.parent(),k=this.getPosition(k),a="bottom"==a&&g.bottom+m>k.bottom?"top":"top"==a&&g.top-m<k.top?"bottom":"right"==a&&g.right+f>k.width?"left":"left"==a&&g.left-f<k.left?"right":a;c.removeClass(h).addClass(a)}g=this.getCalculatedOffset(a,g,f,m);this.applyPlacement(g,
a);a=function(){var a=d.hoverState;d.$element.trigger("shown.bs."+d.type);d.hoverState=null;"out"==a&&d.leave(d)};b.support.transition&&this.$tip.hasClass("fade")?c.one("bsTransitionEnd",a).emulateTransitionEnd(e.TRANSITION_DURATION):a()}}};e.prototype.applyPlacement=function(c,a){var d=this.tip(),g=d[0].offsetWidth,h=d[0].offsetHeight,e=parseInt(d.css("margin-top"),10),f=parseInt(d.css("margin-left"),10);isNaN(e)&&(e=0);isNaN(f)&&(f=0);c.top+=e;c.left+=f;b.offset.setOffset(d[0],b.extend({using:function(a){d.css({top:Math.round(a.top),
left:Math.round(a.left)})}},c),0);d.addClass("in");var f=d[0].offsetWidth,k=d[0].offsetHeight;"top"==a&&k!=h&&(c.top=c.top+h-k);var n=this.getViewportAdjustedDelta(a,c,f,k);n.left?c.left+=n.left:c.top+=n.top;g=(e=/top|bottom/.test(a))?2*n.left-g+f:2*n.top-h+k;h=e?"offsetWidth":"offsetHeight";d.offset(c);this.replaceArrow(g,d[0][h],e)};e.prototype.replaceArrow=function(b,a,d){this.arrow().css(d?"left":"top",50*(1-b/a)+"%").css(d?"top":"left","")};e.prototype.setContent=function(){var b=this.tip(),
a=this.getTitle();b.find(".tooltip-inner")[this.options.html?"html":"text"](a);b.removeClass("fade in top bottom left right")};e.prototype.hide=function(c){function a(){"in"!=d.hoverState&&g.detach();d.$element.removeAttr("aria-describedby").trigger("hidden.bs."+d.type);c&&c()}var d=this,g=this.tip(),h=b.Event("hide.bs."+this.type);return this.$element.trigger(h),h.isDefaultPrevented()?void 0:(g.removeClass("in"),b.support.transition&&this.$tip.hasClass("fade")?g.one("bsTransitionEnd",a).emulateTransitionEnd(e.TRANSITION_DURATION):
a(),this.hoverState=null,this)};e.prototype.fixTitle=function(){var b=this.$element;(b.attr("title")||"string"!=typeof b.attr("data-original-title"))&&b.attr("data-original-title",b.attr("title")||"").attr("title","")};e.prototype.hasContent=function(){return this.getTitle()};e.prototype.getPosition=function(c){c=c||this.$element;var a=c[0],d="BODY"==a.tagName,a=a.getBoundingClientRect();null==a.width&&(a=b.extend({},a,{width:a.right-a.left,height:a.bottom-a.top}));var g=d?{top:0,left:0}:c.offset();
c={scroll:d?document.documentElement.scrollTop||document.body.scrollTop:c.scrollTop()};d=d?{width:b(window).width(),height:b(window).height()}:null;return b.extend({},a,c,d,g)};e.prototype.getCalculatedOffset=function(b,a,d,g){return"bottom"==b?{top:a.top+a.height,left:a.left+a.width/2-d/2}:"top"==b?{top:a.top-g,left:a.left+a.width/2-d/2}:"left"==b?{top:a.top+a.height/2-g/2,left:a.left-d}:{top:a.top+a.height/2-g/2,left:a.left+a.width}};e.prototype.getViewportAdjustedDelta=function(b,a,d,g){var h=
{top:0,left:0};if(!this.$viewport)return h;var e=this.options.viewport&&this.options.viewport.padding||0,f=this.getPosition(this.$viewport);/right|left/.test(b)?(d=a.top-e-f.scroll,a=a.top+e-f.scroll+g,d<f.top?h.top=f.top-d:a>f.top+f.height&&(h.top=f.top+f.height-a)):(g=a.left-e,a=a.left+e+d,g<f.left?h.left=f.left-g:a>f.width&&(h.left=f.left+f.width-a));return h};e.prototype.getTitle=function(){var b=this.$element,a=this.options;return b.attr("data-original-title")||("function"==typeof a.title?a.title.call(b[0]):
...
b(this),c=c.data("target")||c.attr("href"),g=/^#./.test(c)&&b(c);return g&&g.length&&g.is(":visible")&&[[g[a]().top+d,c]]||null}).sort(function(a,d){return a[0]-d[0]}).each(function(){c.offsets.push(this[0]);c.targets.push(this[1])})};e.prototype.process=function(){var a,d=this.$scrollElement.scrollTop()+this.options.offset,b=this.getScrollHeight(),c=this.options.offset+b-this.$scrollElement.height(),f=this.offsets,e=this.targets,k=this.activeTarget;if(this.scrollHeight!=b&&this.refresh(),d>=c)return k!=
(a=e[e.length-1])&&this.activate(a);if(k&&d<f[0])return this.activeTarget=null,this.clear();for(a=f.length;a--;)k!=e[a]&&d>=f[a]&&(!f[a+1]||d<=f[a+1])&&this.activate(e[a])};e.prototype.activate=function(a){this.activeTarget=a;this.clear();a=b(this.selector+'[data-target="'+a+'"],'+this.selector+'[href="'+a+'"]').parents("li").addClass("active");a.parent(".dropdown-menu").length&&(a=a.closest("li.dropdown").addClass("active"));a.trigger("activate.bs.scrollspy")};e.prototype.clear=function(){b(this.selector).parentsUntil(this.options.target,
...
k=b.Event("show.bs.tab",{relatedTarget:f[0]});(f.trigger(m),a.trigger(k),k.isDefaultPrevented()||m.isDefaultPrevented())||(e=b(e),this.activate(a.closest("li"),c),this.activate(e,e.parent(),function(){f.trigger({type:"hidden.bs.tab",relatedTarget:a[0]});a.trigger({type:"shown.bs.tab",relatedTarget:f[0]})}))}};f.prototype.activate=function(a,c,e){function l(){m.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1);
a.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0);k?(a[0].offsetWidth,a.addClass("in")):a.removeClass("fade");a.parent(".dropdown-menu")&&a.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0);e&&e()}var m=c.find("> .active"),k=e&&b.support.transition&&(m.length&&m.hasClass("fade")||!!c.find("> .fade").length);m.length&&k?m.one("bsTransitionEnd",l).emulateTransitionEnd(f.TRANSITION_DURATION):l();m.removeClass("in")};var c=b.fn.tab;
...
f.VERSION="3.3.1";f.RESET="affix affix-top affix-bottom";f.DEFAULTS={offset:0,target:window};f.prototype.getState=function(a,b,c,e){var f=this.$target.scrollTop(),m=this.$element.offset(),k=this.$target.height();if(null!=c&&"top"==this.affixed)return c>f?"top":!1;if("bottom"==this.affixed)return null!=c?f+this.unpin<=m.top?!1:"bottom":a-e>=f+k?!1:"bottom";var n=null==this.affixed,f=n?f:m.top;return null!=c&&c>=f?"top":null!=e&&f+(n?k:b)>=a-e?"bottom":!1};f.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;
this.$element.removeClass(f.RESET).addClass("affix");var a=this.$target.scrollTop();return this.pinnedOffset=this.$element.offset().top-a};f.prototype.checkPositionWithEventLoop=function(){setTimeout(b.proxy(this.checkPosition,this),1)};f.prototype.checkPosition=function(){if(this.$element.is(":visible")){var a=this.$element.height(),d=this.options.offset,c=d.top,e=d.bottom,l=b("body").height();"object"!=typeof d&&(e=c=d);"function"==typeof c&&(c=d.top(this.$element));"function"==typeof e&&(e=d.bottom(this.$element));
d=this.getState(l,a,c,e);if(this.affixed!=d){null!=this.unpin&&this.$element.css("top","");var c="affix"+(d?"-"+d:""),m=b.Event(c+".bs.affix");if(this.$element.trigger(m),m.isDefaultPrevented())return;this.affixed=d;this.unpin="bottom"==d?this.getPinnedOffset():null;this.$element.removeClass(f.RESET).addClass(c).trigger(c.replace("affix","affixed")+".bs.affix")}"bottom"==d&&this.$element.offset({top:l-a-e})}};var c=b.fn.affix;b.fn.affix=e;b.fn.affix.Constructor=f;b.fn.affix.noConflict=function(){return b.fn.affix=
c,this};b(window).on("load",function(){b('[data-spy="affix"]').each(function(){var a=b(this),d=a.data();d.offset=d.offset||{};null!=d.offsetBottom&&(d.offset.bottom=d.offsetBottom);null!=d.offsetTop&&(d.offset.top=d.offsetTop);e.call(a,d)})})}(jQuery);!function(b,e,f){var c=window.matchMedia;"undefined"!=typeof module&&module.exports?module.exports=f(c):"function"==typeof define&&define.amd?define(function(){return e[b]=f(c)}):e[b]=f(c)}("enquire",this,function(b){function e(a,b){var c,e=0,f=a.length;for(e;f>e&&(c=b(a[e],e),!1!==c);e++);}function f(a){this.options=a;!a.deferSetup&&this.setup()}function c(a,c){this.query=a;this.isUnconditional=c;this.handlers=[];this.mql=b(a);var e=this;this.listener=function(a){e.mql=a;e.assess()};this.mql.addListener(this.listener)}
function a(){if(!b)throw Error("matchMedia not present, legacy browsers require a polyfill");this.queries={};this.browserIsIncapable=!b("only all").matches}return f.prototype={setup:function(){this.options.setup&&this.options.setup();this.initialised=!0},on:function(){!this.initialised&&this.setup();this.options.match&&this.options.match()},off:function(){this.options.unmatch&&this.options.unmatch()},destroy:function(){this.options.destroy?this.options.destroy():this.off()},equals:function(a){return this.options===
a||this.options.match===a}},c.prototype={addHandler:function(a){a=new f(a);this.handlers.push(a);this.matches()&&a.on()},removeHandler:function(a){var b=this.handlers;e(b,function(c,e){return c.equals(a)?(c.destroy(),!b.splice(e,1)):void 0})},matches:function(){return this.mql.matches||this.isUnconditional},clear:function(){e(this.handlers,function(a){a.destroy()});this.mql.removeListener(this.listener);this.handlers.length=0},assess:function(){var a=this.matches()?"on":"off";e(this.handlers,function(b){b[a]()})}},
a.prototype={register:function(a,b,f){var l=this.queries;f=f&&this.browserIsIncapable;return l[a]||(l[a]=new c(a,f)),"function"==typeof b&&(b={match:b}),"[object Array]"===Object.prototype.toString.apply(b)||(b=[b]),e(b,function(b){"function"==typeof b&&(b={match:b});l[a].addHandler(b)}),this},unregister:function(a,b){var c=this.queries[a];return c&&(b?c.removeHandler(b):(c.clear(),delete this.queries[a])),this}},new a});
