...
class Certificate extends CI_Controller {
    ...
    public function generate(){
        ...
        if($type=='user'){
            ...
            $text = "Certificamos que ".strtoupper($user->name)." participou do XXI SEMINÁRIO DE PESQUISA DO CCSA - \"CIDADANIA EM TEMPOS DE INTOLERÂNCIA\", realizado no Centro de Ciências Sociais Aplicadas da Universidade Federal do Rio Grande do Norte, no período de 2 a 6 de maio de 2016.";
            ...
            $certgen = $mu->certgen;
            $text = "Certificamos que ".strtoupper($mu->user->name)." participou do minicurso ".strtoupper($mu->minicourse->title).", ministrado por ".strtoupper($final)." no XXI SEMINÁRIO DE PESQUISA DO CCSA - \"CIDADANIA EM TEMPOS DE INTOLERÂNCIA\", realizado no Centro de Ciências Sociais Aplicadas da Universidade Federal do Rio Grande do Norte, com carga horária de 6h (seis horas).";
            ...
            $certgen = $mu->certgen;
            $text = "Certificamos que ".strtoupper($mu->user->name)." participou da mesa-redonda ".strtoupper($mu->roundtable->title).", coordenada por ".strtoupper($final)." no XXI SEMINÁRIO DE PESQUISA DO CCSA - \"CIDADANIA EM TEMPOS DE INTOLERÂNCIA\", realizada no Centro de Ciências Sociais Aplicadas da Universidade Federal do Rio Grande do Norte, com carga horária de 2h (duas horas).";
            ...
            $certgen = $mu->certgen;
            $text = "Certificamos que ".strtoupper($mu->user->name)." participou da conferência ".strtoupper($mu->conference->title).", apresentada por ".strtoupper($final)." no XXI SEMINÁRIO DE PESQUISA DO CCSA - \"CIDADANIA EM TEMPOS DE INTOLERÂNCIA\", realizada no Centro de Ciências Sociais Aplicadas da Universidade Federal do Rio Grande do Norte, com carga horária de 2h (duas horas).";
            ...
            $certgen = $mu->certgen;
            $text = "Certificamos que ".strtoupper($mu->user->name)." participou da oficina ".strtoupper($mu->workshop->title).", exposta por ".strtoupper($final)." no XXI SEMINÁRIO DE PESQUISA DO CCSA - \"CIDADANIA EM TEMPOS DE INTOLERÂNCIA\", realizada no Centro de Ciências Sociais Aplicadas da Universidade Federal do Rio Grande do Norte, com carga horária de 2h (duas horas).";
            ...
            $certgen = $mu->certgen;
            $text = "Certificamos que ".strtoupper($final)." ".$first." o artigo: \"".strtoupper($mu->title)."\" - GT ".strtoupper($mu->thematicgroup->name).", no XXI SEMINÁRIO DE PESQUISA DO CCSA - \"CIDADANIA EM TEMPOS DE INTOLERÂNCIA\", realizada no Centro de Ciências Sociais Aplicadas da Universidade Federal do Rio Grande do Norte.";
            ...
            $certgen = $mu->certgen;
            $text = "Certificamos que ".strtoupper($final)." ".$first." o pôster: \"".strtoupper($mu->title)."\" GT - ".strtoupper($mu->thematicgroup->name).", no XXI SEMINÁRIO DE PESQUISA DO CCSA - \"CIDADANIA EM TEMPOS DE INTOLERÂNCIA\", realizada no Centro de Ciências Sociais Aplicadas da Universidade Federal do Rio Grande do Norte.";
    ...
    public function acceptTeachingCase() {
        ...
        if( isset( $tc->cernn ) && $tc->cernn!='pending' ){
