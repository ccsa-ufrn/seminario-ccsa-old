...
class Minicourse extends CI_Controller {
    ...
    public function createReport(){
        ...
        $result = R::find('minicourse_user','minicourse_id=?', array($minicourse));
        $m = R::findOne('minicourse','id=?',array($minicourse));
        ...
        $arr = explode ('||', $m->expositor );
        $expositores = implode( ',' , $arr );

        echo "<p><b>Expositor(es):</b> ".$expositores."</p>";
