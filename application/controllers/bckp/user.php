...
class User extends CI_Controller {
	...
	public function login(){
        ...
        $this->load->library( array('rb', 'session', 'email') );
...
;
	...
	public function createUser(){
		...
		$this->load->library( array('rb', 'form_validation', 'session', 'email') );
		$this->load->helper( array('form' , 'url' , 'date' , 'security', 'utility' ) );
        ...
        $this->email->from('assessoriatecnica@ccsa.ufrn.br', 'Seminário de Pesquisa do CCSA');
        $this->email->to($email); 

        $this->email->subject('[Cadastro no Sistema] Seminário de Pesquisa do CCSA');
	...
	public function resetpassword(){
		...
		$this->load->library( array('rb', 'form_validation','email','session') );
		...
		foreach ($users as $user) {
			...
			$this->email->subject('[Recuperando senha] Seminário de Pesquisa do CCSA');
    ...
    public function createReportInscription(){
        ...
        $user = R::findOne('user','id = ?',array($params['id']));
    ...
    function acceptPayment(){
        ...
        $this->email->subject('[Pagamento Aceito] Seminário de Pesquisa do CCSA');
    ...
    function rejectPayment(){
        ...
        $this->email->subject('[Pagamento Rejeitado] Seminário de Pesquisa do CCSA');
    ...
    function freePayment(){
        ...
        $this->email->subject('[Isenção] Seminário de Pesquisa do CCSA');
