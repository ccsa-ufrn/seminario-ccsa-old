...
class Workshop extends CI_Controller {
    ...
    public function enrollView(){
        ...
        $user = R::findOne('user','id=?',array($this->session->userdata('user_id')));
        $ws = R::find('workshop','ORDER BY title ASC');
