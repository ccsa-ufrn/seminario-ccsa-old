    ...
    public function createReport()
    {
        ...
        */
        ...
        $pdf->Cell(
            0, 
            10, 
            utf8_decode( strtoupper ( $conference->title ) ), 
            'LRT',
            0,
            'C',
            true
        ...
        $pdf->Cell(
            251, 
            7, 
            utf8_decode($conference->local.' - '.$conference->vacancies.' vagas '), 
            'TBR',
            0,
            'L',
            false
        ...
        */
        ...
        $result = $conference->with('ORDER BY name ASC')->sharedUserList;
