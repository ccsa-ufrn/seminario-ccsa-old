<div class="row">
    <div class="col-lg-12">
        ...
        <h1 class="page-header">Programação de Artigos</h1>
        ...
        <?php echo form_open(base_url('dashboard/schedule/paper/newrecord'), array('id' => 'formSchedulePaperNewRecord','novalidate' => '','class'=>'waiting form-add-record-behavior')); ?>

            <div class="row">
                <div class="col-md-12"><h3>Adicionar GTs/Artigos à Programação</h3></div>
                <div class="col-md-6 col-xs-6 col-sm-6">

                    <div class="form-group">
                        <label>Grupo Temático *</label>
                        <select data-type="paper" name="thematicgroup" class="select-schedule-tg form-control">
                ...
                <div class="col-md-6 col-xs-6 col-sm-6">
                    ...
                    <div class="form-group">
                        <label>Artigos *</label>
                        <select style="text-transform:uppercase;" class="form-control select-show-types" multiple size="21" name="papers[]">
                            <?php foreach ($papers as $p): ?>
                                <option <?php if(isset($popform['papers']) && in_array($p->id,$popform['papers'])): ?> selected="true" <?php endif; ?> value="<?php echo $p->id; ?>" ><?php echo $p->title; ?></option>
                            <?php endforeach ?>
                        </select>
                        <p class="help-block">Segure o Ctrl ao selecionar mais de um Artigo.</p>
                        <p class="text-danger"><?php if($validation!=null): ?> <?php echo $validation['papers']; ?> <?php endif; ?></p>
                    </div>
...
<div style="margin-top:20px;" class="row">
	<div class="col-lg-12">
		<h3>Registros de Artigos/GTs na Programação</h3>
        ...
        <?php foreach ($records as $rec): ?>
            ...
            <tr>
                <td style="width:50%;">
                    ...
                    <?php 
                        $i = 0;
                        foreach ($rec->ownPaperList as $paper) {
                            if($i++!=0) echo ', ';
                            echo $paper->title;
                        }
                    ?>
