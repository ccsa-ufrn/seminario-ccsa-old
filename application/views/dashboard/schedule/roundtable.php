<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Programação de Mesas-Redondas</h1>
        ...
        <?php echo form_open(base_url('dashboard/schedule/roundtable/newrecord'), array('id' => 'formScheduleRoundtableNewRecord', 'novalidate' => '','class'=>'waiting form-add-record-behavior')); ?>

            <div class="row">
                <div class="col-md-12"><h3>Adicionar Mesa-Redonda à Programação</h3></div>
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="roundtable" class="form-control" style="text-transform:uppercase;">
					  		<?php foreach ($rts as $rt): ?>
                                <option <?php if($popform['roundtable']==$rt->id): ?> selected="true" <?php endif; ?> value="<?php echo $rt->id; ?>"><?php echo $rt->title; ?></option>
                            <?php endforeach ?>
						</select>
                        <p class="text-danger"><?php if($validation!=null): ?> <?php echo $validation['roundtable']; ?> <?php endif; ?></p>
                    </div>
...
<div style="margin-top:20px;" class="row">
	<div class="col-lg-12">
		<h3>Registros Mesas-Redondas na Programação</h3>
        ...
        <?php foreach ($records as $rec): ?>
            ...
            <tr>
                <td>
                    <b><?php echo $rec->roundtable->title; ?></b>
                </td>
