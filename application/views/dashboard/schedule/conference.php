<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Programação de Conferências</h1>
        ...
        <?php echo form_open(base_url('dashboard/schedule/conference/newrecord'), array('id' => 'formScheduleConferenceNewRecord', 'novalidate' => '','class'=>'waiting form-add-record-behavior')); ?>

            <div class="row">
                <div class="col-md-12"><h3>Adicionar Conferência à Programação</h3></div>
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="conference" class="form-control" style="text-transform:uppercase;">
					  		<?php foreach ($cs as $c): ?>
                                <option <?php if($popform['conference']==$c->id): ?> selected="true" <?php endif; ?> value="<?php echo $c->id; ?>"><?php echo $c->title; ?></option>
                            <?php endforeach ?>
						</select>
                        <p class="text-danger"><?php if($validation!=null): ?> <?php echo $validation['conference']; ?> <?php endif; ?></p>
                    </div>
...
<div style="margin-top:20px;" class="row">
	<div class="col-lg-12">
		<h3>Registros de Conferências na Programação</h3>
        ...
        <?php foreach ($records as $rec): ?>
            ...
            <tr>
                <td>
                    <b><?php echo $rec->conference->title; ?></b>
                </td>
