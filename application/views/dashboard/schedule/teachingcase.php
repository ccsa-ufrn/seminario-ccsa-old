<div class="row">
    <div class="col-lg-12">
        ...
        <h1 class="page-header">Programação de Casos para Ensino</h1>
        ...
        <?php echo form_open(base_url('dashboard/schedule/teachingcase/newrecord'), array('id' => 'formScheduleTeachingCaseNewRecord','novalidate' => '','class'=>'waiting form-add-record-behavior')); ?>

            <div class="row">
                <div class="col-md-12"><h3>Adicionar Casos para Ensino à Programação</h3></div>
                ...
                <div class="col-md-6 col-xs-6 col-sm-6">
                    ...
                    <div class="form-group">
                        <label>Casos para Ensino *</label>
                        <select style="text-transform:uppercase;" class="form-control select-show-types" multiple size="21" name="teachingcases[]">
                            <?php foreach ($tcs as $tc): ?>
                                <option <?php if(isset($popform['teachingcases']) && in_array($tc->id,$popform['teachingcases'])): ?> selected="true" <?php endif; ?> value="<?php echo $tc->id; ?>" ><?php echo $tc->title; ?></option>
                            <?php endforeach ?>
                        </select>
                        <p class="help-block">Segure o Ctrl ao selecionar mais de um Caso para Ensino.</p>
                        <p class="text-danger"><?php if($validation!=null): ?> <?php echo $validation['teachingcases']; ?> <?php endif; ?></p>
                    </div>
...
<div style="margin-top:20px;" class="row">
	<div class="col-lg-12">
		<h3>Registros de Casos para Ensino na Programação</h3>
        ...
        <?php foreach ($records as $rec): ?>
            ...
            <tr>
                <td style="width:50%;">
                    <?php 
                        $i = 0;
                        foreach ($rec->ownTeachingcaseList as $tc) {
                            if($i++!=0) echo ', ';
                            echo $tc->title;
                        }
                    ?>
