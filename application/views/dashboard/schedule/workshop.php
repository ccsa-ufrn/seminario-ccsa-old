<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Programação de Oficinas</h1>
        ...
        <?php echo form_open(base_url('dashboard/schedule/workshop/newrecord'), array('id' => 'formScheduleWorkshopNewRecord', 'novalidate' => '','class'=>'waiting form-add-record-behavior')); ?>

            <div class="row">
                <div class="col-md-12"><h3>Adicionar Oficina à Programação</h3></div>
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="workshop" class="form-control" style="text-transform:uppercase;">
					  		<?php foreach ($mcs as $mc): ?>
                                <option <?php if($popform['workshop']==$mc->id): ?> selected="true" <?php endif; ?> value="<?php echo $mc->id; ?>"><?php echo $mc->title; ?></option>
                            <?php endforeach ?>
						</select>
                        <p class="text-danger"><?php if($validation!=null): ?> <?php echo $validation['workshop']; ?> <?php endif; ?></p>
                    </div>
...
<div style="margin-top:20px;" class="row">
	<div class="col-lg-12">
		<h3>Registros de Oficinas na Programação</h3>
        ...
        <?php foreach ($records as $rec): ?>
            ...
            <tr>
                <td>
                    <b><?php echo $rec->workshop->title; ?></b>
                </td>
