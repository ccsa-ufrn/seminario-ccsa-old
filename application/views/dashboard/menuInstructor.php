        <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a <?php if($active=='submit-roundtable'): ?> class="active" <?php endif; ?> href="<?php echo base_url('dashboard/roundtable/submit'); ?>"><i class="fa fa-upload fa-fw"></i> Mesas-Redondas</a>
                        </li>
