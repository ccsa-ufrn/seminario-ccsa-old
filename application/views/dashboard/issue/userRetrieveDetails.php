...
<p><b>Anexo: </b> <a href="<?php echo asset_url(); ?>upload/issues/images/<?php echo $issue->image; ?>" target="_blank">Anexo</a></p>
<?php endif; ?>
...
<?php echo form_open(base_url('dashboard/issue/userreply'), array('id' => 'formIssueResponseUser','novalidate' => '','class' => 'waiting')); ?>
