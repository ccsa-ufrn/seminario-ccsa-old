<h3 style="font-weight:bolder;font-size:16px;">ATUALIZAR OFICINA</h3>

<?php echo form_open(base_url('dashboard/workshop/updateconsolidated'), array('id' => 'formUpdateConsolidateWorkshop','novalidate' => '','class' => 'waiting')); ?>
                ...
                <select class="form-control" name="dayshifts[]" multiple="multiple" size="8">
                    ...
                    <?php foreach ($dss as $ds): ?>
                        <?php if($ds['minicourse']==null || !isset($ds['minicourse'])): ?>
                        	...
                        	<?php $mds = R::find('workshop_workshopdayshift','workshop_id=? AND workshopdayshift_id=?',array($mc->id,$ds->id)); ?>
