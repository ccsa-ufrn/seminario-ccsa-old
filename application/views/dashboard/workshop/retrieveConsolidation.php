 <?php echo form_open(base_url('dashboard/workshop/consolidate'), array('id' => 'formConsolidateWorkshop','novalidate' => '','class' => 'waiting')); ?>
    <input style="display:none;" type="text" name="id" value="<?php echo $ws['id']; ?>">
    <div class="row">
        ...
        <div class="col-md-12 col-xs-12 col-sm-12">
            ...
            <div class="form-group">
                ...
                <p class="text-danger">O propositor tem <b>preferência</b> por <b><?php echo $ws['vacancies']; ?></b> vagas.</p>
                <input type="number" class="form-control" placeholder="Vagas" value="<?php echo $ws['vacancies']; ?>" name="vacancies" />
            </div>
            ...
            <div class="form-group">
                ...
                <p class="text-danger">O propositor tem <b>preferência</b> pelo turno <b><?php echo $ws['shift']; ?></b>.</p>
