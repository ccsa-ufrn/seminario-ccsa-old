...
<?php if($status=='ok'): ?>
	...
	<?php echo form_open(base_url('dashboard/minicourse/deallocate'), array('id' => 'formDeallocateaMinicourse','novalidate' => '','class' => 'waiting')); ?>
...
este minicurso, você PERDERÁ TODOS os registros de inscrições realizados até este momento. Você deseja realmente 
continuar?</p>
