			...
			<div class="row">
                <div class="col-lg-12">
                    ...
                    <h4 class="page-header">Minicursos Submetidos</h4>
                    
                    <table class="table table-hover">
                    <!-- Falta centralizar verticalmente o texto -->    
                    <?php foreach($minicourses as $mc): ?>
                        
                        <tr class="active text-center">
                            
                        <td style="width:40%;"><b><?php echo $mc->title; ?></b></td>
                        <td>Enviado em: <?php echo date("d/m/Y", strtotime($mc->createdAt));  ?> </td>
                        
                        <?php if($mc->consolidated=='no'): ?>
                            <td class="text-warning">Esperando Avaliação</td>
                            <?php $limit = R::findOne('configuration','name="max_date_minicourse_submission"'); ?>
                            <?php if(dateleq(mdate('%Y-%m-%d'),$limit->value)): ?>
                            <td><a style="cursor:pointer;" class="minicourse-cancel-submission" data-data="<?php echo $mc->id;  ?>">Cancelar Submissão</a></td>
                            <?php echo form_open(base_url('dashboard/minicourse/cancelsubmission'), array('id' => 'formMinicourseCancelSubmission-'.$mc->id,'novalidate' => '','class' => 'waiting','style' => 'display:inline-block;')); ?>
                                <input style="display:none;" name="id" value="<?php echo $mc->id; ?>" />
                            </form> 
                            <?php endif; ?>
                        <?php elseif($mc->consolidated=='yes'): ?>
                            <td class="text-success">Minicurso Consolidado/Aceito</td>
                            <td></td>
                        <?php endif; ?>
                    ...
                    <?php if(!count($minicourses)): ?>
                    <tr class="text-center active">
                        <td><span class="text-danger">Você ainda não submeteu nenhum minicurso.</span></td>
                    </tr>
                    <?php endif; ?>
                    
                    </table>

                    <h4 class="page-header">Submeter Minicurso</h4>
                    ...
                    <?php echo form_open(base_url('dashboard/minicourse/create'), array('id' => 'formCreateMinicourse','novalidate' => '','class' => 'waiting')); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="6" class="form-control" placeholder="Objetivos" name="objectives" ><?php echo $popform['objectives']; ?></textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
    								...
    								<input id="programuploader" type="file" name="userfile" data-url="<?php echo base_url(); ?>dashboard/minicourse/uploadprogram" />
                               ...
                               <div class="form-group">
                                    ...
                                    <br/>
                                    <button class="btn btn-default" data-toggle="modal" data-target=".modal-minicourse-add-author" type="button" style="margin-bottom:10px;">Adicionar Expositor</button>
                            ...
                            <div class="col-lg-12 text-center success-container">
                                ...
                                <button type="submit" class="btn btn-lg btn-success">Submeter Minicurso</button>
                            </div>
                        </div>
            ...
            <div class="modal fade modal-minicourse-add-author" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
